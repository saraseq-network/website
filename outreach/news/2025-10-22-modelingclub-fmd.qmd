...
>
> Before we jump into the basics for modeling in R, review the core SIR/SEIR math. Evan B. Porter kindly provided his slides and welcomes questions: evanjporter99\@gmail.com
>
> ::: slide-wrap
> <!-- A single-page-tall viewer; users scroll to see more pages -->
>
> <iframe src="data/SIR_review.pdf#page=1&amp;zoom=page-width" title="Intro math slides" loading="lazy">
>
> </iframe>
> :::
>
...
>
> © 2025 Evan B. Porter. Slides used with permission for educational purposes.
>
> </p>
>
> ```{=html}
> <style>
> /* button */
> .button-wrap{margin-bottom:.5rem}
> .btn-download{
> background:#0056b3;color:#fff!important;padding:.5rem 1rem;border-radius:8px;
...
> .slide-wrap iframe{
> width:100%;
> height:40vh;       /* one-page tall; adjust to taste (e.g., 90vh) */
> border:none;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,.08)
> }
> @media (max-width:768px){ .slide-wrap iframe{ height:75vh } }
> /* copyright */
> .copyright-note{font-size:.85rem;color:#666;margin-top:.6rem;text-align:right}
> </style>
> ```
...
# Defining our beta R0 = Beta * N / gamma
R0_target <- 2.5                  # range from 1.68 to 4.5
beta <- (R0_target * gamma) / N   # density-dependent 
beta
